...
%eline%
echo You are running outdated version %masver%
echo ________________________________________________
echo:
if not defined _MASunattended (
echo [1] Get Latest One
...
cls
title Support
call :_color2 %_White% "       Mail me at:" %_Blue% "support.orbitx.space@gmail.com"
...
echo:
echo:
call :_color2 %_White% "                        " %Blue% " Created By OrbitX.Space "
echo:
echo:
call :_color2 %_White% "        Visit:  " %_Blue% "https://github.com/OrbitX-Space"
echo:
echo:
echo  Your Choice: 
...
if %_erl%==9 exit /b
if %_erl%==8 goto :_Support
if %_erl%==7 goto:Extras
if %_erl%==6 goto :_Support
...
echo:   
echo      Email: orbitx.space95@gmail.com
)>"%_dest%\Info.txt"
exit /b
